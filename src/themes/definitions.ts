...
export const coreThemeDefinitions = [
  {
    ...
    tokens: {
      dark: {
        ...
        'io-well': '#000307', 'io-panel': '#040910', 'io-strip': '#09121D', 'io-border': '#49627F', 'terminal-editor-text': '#F3F7FC', 'terminal-editor-placeholder': '#91A4B9',
      },
      light: {
        ...
        'io-well': '#E4EBF2', 'io-panel': '#FCFEFF', 'io-strip': '#DCE6F0', 'io-border': '#71869D', 'terminal-editor-text': '#F3F7FC', 'terminal-editor-placeholder': '#91A4B9',
      },
    },
  },
  {
    ...
    tokens: {
      dark: {
        ...
        'io-well': '#0C141D', 'io-panel': '#121C26', 'io-strip': '#1A2733', 'io-border': '#4A5D72', 'terminal-editor-text': '#EAF0F6', 'terminal-editor-placeholder': '#8A9BAB',
      },
      light: {
        ...
        'io-well': '#EDF1F4', 'io-panel': '#F7F9FA', 'io-strip': '#E3E8EC', 'io-border': '#98A6B5', 'terminal-editor-text': '#EAF0F6', 'terminal-editor-placeholder': '#8A9BAB',
      },
    },
  },
  {
    ...
    tokens: {
      dark: {
        ...
        'io-well': '#1B2635', 'io-panel': '#263244', 'io-strip': '#324156', 'io-border': '#657995', 'terminal-editor-text': '#EEF3FA', 'terminal-editor-placeholder': '#A4B3C7',
      },
      light: {
        ...
        'io-well': '#E1EAF3', 'io-panel': '#EDF3F9', 'io-strip': '#D5E1ED', 'io-border': '#879CB3', 'terminal-editor-text': '#EEF3FA', 'terminal-editor-placeholder': '#A4B3C7',
      },
    },
  },
  {
    ...
    tokens: {
      dark: {
        ...
        'io-well': '#000000', 'io-panel': '#000000', 'io-strip': '#0A0A0A', 'io-border': '#FFFFFF', 'terminal-editor-text': '#FFFFFF', 'terminal-editor-placeholder': '#D0D0D0',
      },
      light: {
        ...
        'io-well': '#FFFFFF', 'io-panel': '#FFFFFF', 'io-strip': '#E8E8E8', 'io-border': '#000000', 'terminal-editor-text': '#FFFFFF', 'terminal-editor-placeholder': '#D0D0D0',
      },
    },
  },
